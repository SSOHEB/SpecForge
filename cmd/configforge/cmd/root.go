...
var rootCmd = &cobra.Command{
	Use:   "configforge",
	Short: "configforge is a semantic configuration management framework",
	Long: `configforge is a command-line tool that parses configuration metadata specifications,
