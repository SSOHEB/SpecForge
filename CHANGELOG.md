...
- Cobra CLI for `configforge` with subcommands: `defaults`, `validate`, `generate`, `schema`, `docs`, `init`, and `completion`.
...
### Changed
- Standardized project name to `configforge`, updating module path, CLI binary, and environment prefixes.
